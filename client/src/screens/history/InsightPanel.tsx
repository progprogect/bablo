...
/**
 * Строка с часами по возрастанию времени: первые VISIBLE_HOURS_LIMIT сразу, остальные —
 * по кнопке (как у пресетов). Сервер отдаёт все подходящие часы, поэтому час, который
 * виден в истории как тейк, всегда можно найти в подсказке — раньше он молча обрезался топ-3.
 */
