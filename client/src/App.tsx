      ...
      <AuthGate>
        <div className="mx-auto flex min-h-screen w-full max-w-5xl md:items-start">
          ...
          {/* На мобильном — обычная колонка на всю ширину с отступом под BottomNav
              (pb-bottom-nav учитывает и высоту панели, и safe-area iPhone — иначе
              последняя карточка списка и кнопка "Показать ещё" уходят под навигацию).
          ...
          <div className="flex w-full flex-1 flex-col pb-bottom-nav md:mx-auto md:max-w-md md:pb-10 md:pt-10">
            <Routes>
