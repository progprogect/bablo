...
/**
 * Пресеты R/R для выбора тейка. До 21.08.2026 список доходил до 1/10 — обрезан до 1/6:
 * дальние цели не используются, а при 1/5+ и так обязательна частичная фиксация.
 * У старых сделок rrPreset "1/7".."1/10" остаётся в БД как строка — на расчёты не влияет
