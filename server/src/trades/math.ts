...
/**
 * Пресеты R/R для выбора тейка. Список последовательно сокращался: до 1/10 (до 21.08.2026),
 * до 1/6 (30.08.2026), до 1/4 (31.08.2026) — дальние цели не использовались.
 ...
 * из инсайтов по пресетам такие сделки просто выпадают, в сетке статистики их и не было
 * (STATS_GRID_PRESETS — те же 1/1…1/4).
 */
